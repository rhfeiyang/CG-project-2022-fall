...
void Shader::Set(const std::string &name, const gVec2 &value) const {
  Use();
...
void Shader::Set(const std::string &name, const gVec3 &value) const {
  Use();
...
void Shader::Set(const std::string &name, const gVec4 &value) const {
  Use();
...
void Shader::Set(const std::string &name, const gMat2 &mat) const {
  Use();
  glUniformMatrix2fv(GetUniformLocation(name), 1, GL_FALSE, glm::value_ptr(mat));
}
void Shader::Set(const std::string &name, const gMat3 &mat) const {
  Use();
  glUniformMatrix3fv(GetUniformLocation(name), 1, GL_FALSE, glm::value_ptr(mat));
}
void Shader::Set(const std::string &name, const gMat4 &mat) const {
  Use();
