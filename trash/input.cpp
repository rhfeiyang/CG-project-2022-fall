...
gVec3 Input::mouse_position = gVec3(0, 0, 0);
gVec3 Input::mouse_position_frame_offset = gVec3(0, 0, 0);
...
/*static*/ void Input::Update() {
  ...
  gVec3 mouse_pos_this_frame(glfw_mouse_pos_x, window_height - glfw_mouse_pos_y, 0);
  mouse_position_frame_offset = mouse_pos_this_frame - mouse_position;
  mouse_position = mouse_pos_this_frame;
  if (is_first_frame) {
    mouse_position_frame_offset = gVec3(0, 0, 0);
